        ...
        <ThemeProvider theme = {customtheme}>
            ...
            <Grid container direction="column" spacing={0}>
                ...
                <Grid item xs >
                    ...
                    <div className={classes.walletAlignment}>
                    <Typography variant='h3' style={{ display:'flex',paddingBottom:'4%',paddingLeft:'24px',color: '#7D7D89'}}>Total Balance</Typography>
                    <Typography varinat='h4' className={classes.amountAlignment}>
                    <NumberFormat value={parseFloat(portfolioBalance).toFixed(6)} displayType={'text'} thousandSeparator={true} prefix={'$'} />
                    </Typography>
                    </div>
                    <Divider className={classes. divider}/>
                </Grid>
